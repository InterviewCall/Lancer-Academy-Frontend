  ...
  return (
    <div className="relative min-h-screen bg-white text-black  flex flex-col items-center">
      ...
      <div className="w-95/100 md:w-8/10 pt-20 ">
        {/* Page Title */}
        <h1 className="text-5xl md:text-5xl font-extrabold mb-12 tracking-tight">
          Lancrs Academy Refund and Placement Assistance Policy
        </h1>
        ...
        <div className="space-y-12 text-base md:text-lg leading-relaxed text-black/75">
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              {`("Lancrs Academy," "we," "our," or "us")`}, we are committed to
              providing a transparent and fair refund experience. This policy
              outlines the terms and conditions under which candidates may
              request refunds and receive placement assistance.
            </p>
            <p>
              By enrolling in any of our programs, you agree to the terms
              described in this Refund and Placement Assistance Policy.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              <span className="text-black font-semibold">14 days</span> of
              enrollment and request a full refund of their entire payment
              amount.
            </p>
            <p className="mb-4">
              To qualify for a refund during the 14-day trial period, you must
              meet <span className="text-black font-semibold">all</span> of the
            ...
            <p>
              Failure to meet any of the above conditions will render the trial
              period invalid and you will not be eligible for a refund.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              All refund requests must be submitted in writing within the 14-day
              trial window to{" "}
              <a
                href="mailto:academy@lancrs.com"
                className="text-black font-medium underline underline-offset-4 hover:text-black/60 transition-colors"
              >
                academy@lancrs.com
              </a>
              . Each request will be reviewed against attendance records and
              assignment completion status. Refunds are processed only if all
          ...
          <section>
            ...
            <p className="mb-4">
              Post trial, candidates remain eligible for a performance-based
              refund at the end of the program. To qualify, candidates must
              complete all program requirements within the specified time frame
              — <span className="text-black font-semibold">4 or 7 months</span>,
              depending on the program enrolled in.
            </p>
            <p className="mb-4">
              Candidates must meet{" "}
              <span className="text-black font-semibold">all</span> of the
          ...
          {/* <section>
            ...
            <p className="mb-4">
              After completing the 4 or 7-month learning period, candidates who have fulfilled all
          ...
          <section>
            ...
            <p className="mb-4">
              After completing the 4 or 7-month learning period, candidates who
              have fulfilled all requirements within the scheduled screening day
              (as announced after the program starts) will receive{" "}
              <span className="text-black font-semibold">
                4 months of dedicated placement assistance
              </span>
              . During this time, the placement team will actively support
              candidates through:
            </p>

            <p className="mb-4">
              In Lancrs Academy, placement assistance will be provided only for
              job opportunities in the expected salary range of{" "}
              <span className="text-black font-semibold">
                ₹10 LPA to ₹12 LPA
              </span>
              .
          ...
          <section>
            ...
            <p className="mb-4">
              If a candidate does not secure a job within the 4-month placement
              assistance window, they may choose one of the following options:
            </p>
            <ol className="space-y-4 pl-1">
              {[
                {
                ...
                },
                {
                  ...
                  desc: "Access an additional 4 months of self-paced assistance with ongoing support and resources. Candidates who select this option forfeit the right to request a refund.",
                },
              ].map((item, i) => (
                <li key={i} className="flex gap-3">
                  <span className="text-black font-bold min-w-6">{i + 1}.</span>
          ...
          <section>
            ...
            <p className="mb-4">
              Candidates who fail to complete any of the performance clauses
              (attendance, assignment submission, assessment completion, project
              participation, or mock interview clearance) on the scheduled
              screening day will{" "}
              <span className="text-black font-semibold">not</span> be eligible
              for the performance-based refund.
            </p>
            <p className="mb-4">
              ...
              post the screening day for candidates to fulfill the pending
              requirements. Upon completion, candidates proceed to the 4-month
              dedicated placement assistance period.
            </p>
            <p>
              If candidates fail to complete the pending clauses within the
              extended period, they will not be eligible for further placement
              assistance or a refund.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-3 pl-1">
              {[
                "All refund requests must be submitted in writing via the designated email: academy@lancrs.com.",
          ...
          <section>
            ...
            <div className="bg-white/5 border border-black/10 rounded-xl p-6 space-y-3 text-base">
              {[
                {
                  label: "Refund Requests & General Inquiries",
                  email: "academy@lancrs.com",
                },
