...
export default function TutorSection() {
  return (
    <div id="tuition" className="max-md:px-2">
      <div className="w-full text-center my-10 rounded-4xl max-md:rounded-lg bg-white px-5 sm:px-10 p-10 flex flex-col items-center">
      <div className="font-semibold text-5xl max-md:text-3xl max-md:px-8 max-md:pt-6 mb-2 w-10/10 sm:w-6/10">
        <div>1-on-1 mentorship from top industry engineers </div>
        {/* <div>engineers</div> */}
      </div>
      ...
      <div className="sm:flex justify-center w-full mt-10">
        ...
        <div className="sm:basis-15/50 flex justify-start text-xl  text-center font-semibold ">
          {" "}
          <div className="ml-10 max-md:ml-0 max-md:px-4 sm:w-2/3 mt-5 text-start">
