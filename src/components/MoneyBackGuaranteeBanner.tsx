...
export function MoneyBackGuaranteeBannerLaptop() {
  return (
    <div className="hidden bg-white sm:flex items-center justify-center w-full my-10 relative sm:rounded-tr-[100px] sm:rounded-bl-[100px]">
      ...
      <div className="w-full  sm:flex p-16">
        ...
        <div className="sm:basis-2/3">
          <div className="text-4xl font-medium ">
            We believe you’ll get into tech in 10 months. In fact, we put money on it.

          </div>

          <div className="flex items-center justify-evenly gap-x-3 my-3 leading-4.5">
            <div>
              <div className="font-semibold text-lg">1</div>
              Complete the full Lancrs Academy program—live classes, assignments, assessments, projects, hackathons, and mock interviews—within the required timeline.

            </div>
            <div>
              <div className="font-semibold text-lg">2</div>Participate in your dedicated placement assistance period and actively apply to relevant roles with support from our placement team
            </div>
            <div>
              <div className="font-semibold text-lg">3</div>If you still don’t get a job within the guaranteed placement window, and you have fulfilled all program requirements, you’ll get a <span className="font-semibold">100% refund</span> as per our performance-based refund policy.
          ...
          <div className="flex items-center justify-end  w-full text-xs">
            ...
            <div className="w-4/10 px-3 py-2 rounded-md bg-red-100">
              <Hand />
              The Lancrs Academy performance-based refund policy is legally binding. For details, please see our Refund & Placement Policy.
            </div>
          </div>
          ...
          <div className="flex items-start ">
            ...
            <div className="basis-2/3 text-xs pl-5">
              After starting the Lancrs Academy program, you have 14 days to withdraw and receive a 100% refund.
              After that, you’re covered by our performance-based refund policy—complete all program requirements and, if you don’t land a job during the placement period, you’ll receive a full refund.
              Check our <u>Refund & Placement Policy</u> for more details.
            </div>
          </div>
        </div>
      </div>
