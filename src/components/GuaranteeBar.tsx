...
export default function GuaranteeBar() {
  ...
  return (
    <div className="w-full relative flex justify-center mb-30">
      <div className="w-11/12 flex flex-wrap justify-around items-center gap-6 bg-white rounded-xl shadow-sm py-6 px-6">
          ...
          >
            ...
            {index === 0 && (
              <div className="mx-2 group p-1.5 rounded-md bg-gray-100 hover:cursor-pointer">
                ...
                <div className="absolute hidden group-hover:flex justify-center w-full left-0 top-[85%]">
                  <div className="w-6/10 border-red-50 rounded-2xl bg-gray-100 p-5 text-center font-light text-xl text-gray-800 shadow-lg ">
