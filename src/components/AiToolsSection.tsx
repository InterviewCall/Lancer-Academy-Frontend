...
export default function AIToolsSection() {
  return (
    <div className="w-full max-md:px-2">
      <div className="w-full space-y-16 border-black bg-[#ffffff] rounded-xl px-4 sm:px-10 pt-10 my-10 mt-20">
        <div className="md:flex space-y-10 justify-evenly items-center">
          ...
          software engineers, while mastering the core skills to do the job */}
            <span className="text-[#ea6e39] ">Learn AI tools</span> used by
            today’s top engineers while mastering the core skills that make you
            truly job-ready
          </div>
          {/* box here */}
        ...
        <div className="sm:flex  justify-between ">
          ...
          <div className="w-full lg:w-3/5 px-5 max-md:pr-5 max-md:pl-1">
            <div className="font-semibold text-3xl">
              Automate your workflow with AI while learning full-stack
              development:
            </div>
            <div className="sm:grid grid-cols-2 gap-x-8 gap-y-5 space-y-3 my-10">
              <div>
                <FaCircleCheck />
                <div>
                  AI-assisted coding with GitHub Copilot and smart completion
                  tools
                </div>
              </div>
              <div className="">
              ...
              <div className="">
                <FaCircleCheck />
                <div>Automated code review and quality analysis</div>
              </div>
              <div className="">
                <FaCircleCheck />
                <div>
            ...
            <div className="block md:hidden md:w-15/50 w-[90%] relative rounded-xl -translate-x-2 -translate-y-4 space-y-4 p-4 text-sm bg-[#ff976b]">
              <div className="absolute -top-[7%] right-[80%]">
                <Image
                  alt=""
                  src={"/orange_up_arrow.svg"}
                  height={50}
                  width={50}
                />
              </div>
              <div className="text-[16px] font-medium">
                Software fundamentals + real AI experience make you more
            ...
            <div className="w-full hidden  relative bottom-[-10%] -right-10 mt-15 sm:flex lg:flex items-end justify-start gap-x-4 font-light text-xs text-gray-500">
              <div>*Source: India Developer Survey 2024</div>
              <div>**Source: Gartner AI Engineering Adoption Report</div>
            </div>
          </div>
        </div>
